...
### ⚡ قاعدة الدرجات الأساسية:
**هام جداً**: إذا كانت الإجابة صحيحة (correct)، أعطِ الدرجة الكاملة لذلك الجزء!

### خطوات حساب الدرجة:
1. عدّ عدد الأسئلة الفرعية في ورقة الإجابة (مثل: 1-، 2-، 3-، أ)، ب)، ج) )
2. قسّم {max_score} على عدد الأسئلة الفرعية = نقاط لكل فرع
3. أعطِ النقاط الكاملة لكل إجابة صحيحة

### مثال عملي:
- إذا كان max_score = 25 ولديك 10 أسئلة فرعية
- كل سؤال فرعي = 2.5 نقطة
- 4 إجابات صحيحة = 4 × 2.5 = 10 نقاط

### معايير التقييم:
- **correct** ✅: الإجابة تدل على فهم المفهوم → **نقاط كاملة**
- **partial** ⚠️: فهم جزئي → **نصف النقاط**
- **mistake** ❌: المفهوم خاطئ → **صفر نقاط**
- **unclear** ❔: لا يمكن قراءة الخط → **صفر نقاط**

### ⚠️ تحذير مهم - كن متساهلاً:
- إذا أظهر الطالب **أي فهم للمفهوم** → اعتبره صحيحاً!
- لا تطلب تفاصيل إضافية من المنهج إذا كانت الفكرة الأساسية صحيحة
- **كلمات مختلفة للمعنى نفسه = صحيح!**
